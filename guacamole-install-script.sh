...
#  http://guacamole.incubator.apache.org/doc/0.9.12-incubating/gug/
#  http://guacamole.incubator.apache.org/doc/0.9.12-incubating/gug/administration.html
...
GUACA_VER="0.9.12-incubating"
MYSQL_CONNECTOR_VER="5.1.42"
LIBJPEG_VER="1.5.1"
SCRIPT_BUILD="1"
...
yum install -y policycoreutils-{python,devel} | tee -a $logfile
sleep 1 | echo -e "\nSetting SELinux...\n" | pv -qL 25; echo -e "\nSetting SELinux...\n" >> $logfile  2>&1
